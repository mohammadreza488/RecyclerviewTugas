...
public class ExerciseAdapter extends RecyclerView.Adapter<ExerciseAdapter.ViewHolder> {
    ...
    public ExerciseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == WHITE_BG) {
            ...
            view = LayoutInflater.from(context)
                    .inflate(R.layout.item_exercise_k, parent, false);
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            logoImage =itemView.findViewById(R.id.news_logo);
            companyText=itemView.findViewById(R.id.news_source);
            judulText =itemView.findViewById(R.id.news_title);
        }
    }
    }
